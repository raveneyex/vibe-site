...
import { ProCardSVG, MagickCardSVG, TattooCardSVG } from '@/components/NavDeck/SectionIcons';
import { NavCardVariant, type NavDeckTranslations, type NavDeckContent, type HoverCard } from '@/components/NavDeck/types';
import useBackgroundTintOnHover from '@/hooks/useBackgroundTintOnHover';
import useTypewriter from '@/hooks/useTypewriter';
import NavCard from '@/components/NavDeck/NavCard';
